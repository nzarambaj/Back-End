#!/usr/bin/env python3
"""
Setup PostgreSQL Database - Working Version
...
'''
    ...
    with open(r"C:\\Users\\TTR\\Documents\\Project_BackEnd\\setup_database.sql", "w", encoding='utf-8') as f:
...
def execute_database_setup():
    ...
    try:
        ...
        result = subprocess.run([
            ...
            '-d', 'postgres', '-f', r'C:\\Users\\TTR\\Documents\\Project_BackEnd\\setup_database.sql'
...
def create_working_backend():
    ...
    print("\n CREATING WORKING BACKEND")
    print("=" * 60)
    
    working_backend = '''// Working Backend with PostgreSQL Integration
...
app.get('/api/health', (req, res) => {
  res.json({
    status: 'healthy',
    service: 'Working Backend with PostgreSQL 18',
...
'''
    ...
    with open(r"C:\\Users\\TTR\\Documents\\Project_BackEnd\\working_backend.js", "w", encoding='utf-8') as f:
...
def test_working_backend():
    """Test working backend with proper database"""
...
def main():
    ...
    # Step 3: Create working backend
    if setup_executed:
        backend_created = create_working_backend()
    else:
        backend_created = False
    
    # Step 4: Test working backend
    if backend_created:
        backend_tested = test_working_backend()
    else:
    ...
    if setup_created and setup_executed and backend_created and backend_tested:
        ...
        if not backend_created:
            print("- Working backend not created")
        if not backend_tested:
            print("- Working backend not tested")
