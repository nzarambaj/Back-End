#!/usr/bin/env python3
"""
Updated Frontend Credentials Information
Display all available login credentials including the new user1/pass123
"""

from datetime import datetime

def show_updated_frontend_credentials():
    """Display all frontend login credentials including new user"""
    print(" UPDATED FRONTEND LOGIN CREDENTIALS")
    print("=" * 50)
    ...
    print("doctor: Medical professional access")
    print("radiologist: Radiology specialist access")
    print("user: Basic user access")
    ...
    print("\nTESTING RESULTS:")
    print("-" * 40)
    print("All credentials tested successfully")
    print("New user1/pass123 login: WORKING")
    print("Authenticated access: VERIFIED")
    print("Role-based permissions: ACTIVE")
...
if __name__ == "__main__":
    show_updated_frontend_credentials()
